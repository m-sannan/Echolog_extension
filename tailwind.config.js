...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        "inverse-primary": "#3b82f6", "surface-container-lowest": "#ffffff", "outline": "#6b7c65",
        "inverse-on-surface": "#f0f1f2", "surface-container-low": "#f3f4f5", "on-tertiary-container": "#5a616f",
        "surface-tint": "#2563eb", "on-secondary-fixed": "#1b1b1b", "on-primary-container": "#1e3a8a",
        "on-secondary-container": "#646464", "secondary-container": "#e2e2e2", "primary-fixed": "#bfdbfe",
        ...
        "on-background": "#191c1d", "tertiary": "#585f6c", "primary": "#3b82f6",
        ...
        "on-primary-fixed-variant": "#1e3a8a", "secondary-fixed-dim": "#c6c6c6", "tertiary-container": "#d6dded",
        "on-error": "#ffffff", "primary-fixed-dim": "#60a5fa", "on-secondary-fixed-variant": "#474747",
        "secondary": "#5e5e5e", "on-secondary": "#ffffff", "on-surface": "#191c1d",
        "surface-bright": "#f8f9fa", "on-primary-fixed": "#1e3a8a", "error-container": "#ffdad6",
        "tertiary-fixed-dim": "#c0c7d6", "surface-container-highest": "#e1e3e4", "primary-container": "#dbeafe",
